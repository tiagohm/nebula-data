...
class Nebula extends Equatable {
  ...
  factory Nebula.fromJson(json) {
    ...
    return Nebula(
      ...
      vdbh: json['vdbh'],
      mType: json['mType'],
      bMag: json['bMag']?.toDouble(),
      vMag: json['vMag']?.toDouble(),
      majorAxisSize: json['majorAxisSize']?.toDouble(),
      minorAxisSize: json['minorAxisSize']?.toDouble(),
      orientationAngle: json['orientationAngle'],
      distance: json['distance']?.toDouble(),
      distanceErr: json['distanceErr']?.toDouble(),
      redshift: json['redshift']?.toDouble(),
      redshiftErr: json['redshiftErr']?.toDouble(),
      parallax: json['parallax']?.toDouble(),
      parallaxErr: json['parallaxErr']?.toDouble(),
      ra: json['ra'],
      dec: json['dec'],
      type: NebulaType.values[json['type']],
      names: names == null
          ? const []
          : (names as List).map((e) => '$e').toList(growable: false),
      surfaceBrightness: json['surfaceBrightness']?.toDouble(),
